...
public class GetFollowedArtists extends BaseTest{
	
	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from Spotify_Data where REQUEST ='get followed artist'")
	...
	public void test(String SL_No, String REQUEST,String ids) {
		...
		Response response= ApiActionUtil.getMethodWithQueryParam(Endpoints.GET_FOLLOWED_ARTISTS, Endpoints.OK,"type",ids);
